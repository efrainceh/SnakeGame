...
public class SoundManager {
    ...
    static private final HashMap<Sound, URL> soundURL = loadURLMap("static/sound");
    static private Clip loop;
    static private Clip single;
    ...
    private static HashMap<Sound, URL> loadURLMap(String folderPath) {
        ...
        ArrayList<String> soundPaths = folderH.getFilePaths(folderPath, "wav");
    ...
    private void setFile(Sound sound, boolean isLoop) {
